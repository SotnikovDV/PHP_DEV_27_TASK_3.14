***PHP_DEV_27 >> [Справочник по GIT](README.md) >> [Приложения](/appendix.md)***
...
<table>
  <tr>
    ...
    <td>
        <h1>Приложение 2. Шпаргалка по консольным командам Git</h1>
    </td>
  </tr> 
</table>
...
```
(см. [`git add -i`](https://git-scm.com/book/ru/v2/Инструменты-Git-Интерактивное-индексирование))
