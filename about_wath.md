***PHP_DEV_27 >> [Справочник по GIT](README.md) >> [Введение](about.md)***
...
![Хранение данных как набора изменений относительно первоначальной версии каждого из файлов](/img/aw1.png)
...
![Хранение данных как снимков проекта во времени](/img/aw2.png)
...
![Рабочая копия, область индексирования и каталог Git](/img/qw3.png)
